...
typedef enum
{
    SPI_DATA_LENGHT_4B    =  ((uint8_t)0x03),  //!< Set data length to 4 bits
    SPI_DATA_LENGHT_5B    =  ((uint8_t)0x04),  //!< Set data length to 5 bits
    SPI_DATA_LENGHT_6B    =  ((uint8_t)0x05),  //!< Set data length to 6 bits
    SPI_DATA_LENGHT_7B    =  ((uint8_t)0x06),  //!< Set data length to 7 bits
    SPI_DATA_LENGHT_8B    =  ((uint8_t)0x07),  //!< Set data length to 8 bits
    SPI_DATA_LENGHT_9B    =  ((uint8_t)0x08),  //!< Set data length to 9 bits
    SPI_DATA_LENGHT_10B   =  ((uint8_t)0x09),  //!< Set data length to 10 bits
    SPI_DATA_LENGHT_11B   =  ((uint8_t)0x0A),  //!< Set data length to 11 bits
    SPI_DATA_LENGHT_12B   =  ((uint8_t)0x0B),  //!< Set data length to 12 bits
    SPI_DATA_LENGHT_13B   =  ((uint8_t)0x0C),  //!< Set data length to 13 bits
    SPI_DATA_LENGHT_14B   =  ((uint8_t)0x0D),  //!< Set data length to 14 bits
    SPI_DATA_LENGHT_15B   =  ((uint8_t)0x0E),  //!< Set data length to 15 bits
    SPI_DATA_LENGHT_16B   =  ((uint8_t)0x0F),  //!< Set data length to 16 bits
} SPI_DATA_LENGTH_T;
...
typedef enum
{
    SPI_CRC_LENGHT_8B       = ((uint8_t)0), //!< 8-bit CRC length
    SPI_CRC_LENGHT_16B      = ((uint8_t)1), //!< 16-bit CRC length
} SPI_CRC_LENGHT_T;
...
typedef enum
{
    I2S_DATA_LENGHT_16B   =  ((uint8_t)0x00),       //!< Set data length to 16 bits
    I2S_DATA_LENGHT_16BEX =  ((uint8_t)0x01),       //!< Set data length to 16 bits
    I2S_DATA_LENGHT_24B   =  ((uint8_t)0x03),       //!< Set data length to 24 bits
    I2S_DATA_LENGHT_32B   =  ((uint8_t)0x05),       //!< Set data length to 32 bits
} I2S_DATA_LENGTH_T;
...
void SPI_ConfigDatalenght(SPI_T* spi, uint8_t length);
...
/**  CRC */
void SPI_CRCLength(SPI_T* spi, SPI_CRC_LENGHT_T  crcLength);
void SPI_EnablCRC(SPI_T* spi);
