...
void TMR_Reset(TMR_T* TMRx)
{
    ...
    else if (TMRx == TMR2)
    {
        ...
        RCM_DisableAPB1PeriphClock(RCM_APB1_PERIPH_TMR2);
    }
    else if (TMRx == TMR3)
    {
        RCM_EnableAPB1PeriphClock(RCM_APB1_PERIPH_TMR3);
        RCM_DisableAPB1PeriphClock(RCM_APB1_PERIPH_TMR3);
    }
    else if (TMRx == TMR6)
    {
    ...
    else if (TMRx == TMR7)
    {
        ...
        RCM_DisableAPB1PeriphClock(RCM_APB1_PERIPH_TMR7);
    }
    else if (TMRx == TMR14)
    {
        RCM_EnableAPB1PeriphClock(RCM_APB1_PERIPH_TMR14);
        RCM_DisableAPB1PeriphClock(RCM_APB1_PERIPH_TMR14);
    }
    else if (TMRx == TMR15)
    {
        RCM_EnableAPB2PeriphClock(RCM_APB2_PERIPH_TMR15);
        RCM_DisableAPB2PeriphClock(RCM_APB2_PERIPH_TMR15);
    }
    else if (TMRx == TMR16)
    {
        RCM_EnableAPB2PeriphClock(RCM_APB2_PERIPH_TMR16);
        RCM_DisableAPB2PeriphClock(RCM_APB2_PERIPH_TMR16);
    }
    else if (TMRx == TMR17)
    {
        RCM_EnableAPB2PeriphClock(RCM_APB2_PERIPH_TMR17);
        RCM_DisableAPB2PeriphClock(RCM_APB2_PERIPH_TMR17);
    }
}
