 ...
 *                          @arg SPI_DATA_LENGHT_4B:  Set data length to 4 bits
 *                          @arg SPI_DATA_LENGHT_5B:  Set data length to 5 bits
 *                          @arg SPI_DATA_LENGHT_6B:  Set data length to 6 bits
 *                          @arg SPI_DATA_LENGHT_7B:  Set data length to 7 bits
 *                          @arg SPI_DATA_LENGHT_8B:  Set data length to 8 bits
 *                          @arg SPI_DATA_LENGHT_9B:  Set data length to 9 bits
 *                          @arg SPI_DATA_LENGHT_10B:  Set data length to 10 bits
 *                          @arg SPI_DATA_LENGHT_11B:  Set data length to 11 bits
 *                          @arg SPI_DATA_LENGHT_12B:  Set data length to 12 bits
 *                          @arg SPI_DATA_LENGHT_13B:  Set data length to 13 bits
 *                          @arg SPI_DATA_LENGHT_14B:  Set data length to 14 bits
 *                          @arg SPI_DATA_LENGHT_15B:  Set data length to 15 bits
 *                          @arg SPI_DATA_LENGHT_16B:  Set data length to 16 bits
 *
 * @retval      None
 */
 ...
 *                         The parameter can be one of following values:
 *                         @arg SPI_CRC_LENGHT_8B:  8-bit CRC length
 *                         @arg SPI_CRC_LENGHT_16B: 16-bit CRC length
 *
 * @retval      None
 */
